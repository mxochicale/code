...
#s single seven neuron layer (logistic regression) with a logistic activation (Sigmoid)
...
#single neuron model (logistic regression) with a logistic activation (Sigmoid).
