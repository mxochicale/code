...
# https://examples.vtk.org/site/Python/Visualization/FroggieView/
# https://gitlab.kitware.com/vtk/vtk-examples/-/blob/master/src/Python/Visualization/FroggieView.py
