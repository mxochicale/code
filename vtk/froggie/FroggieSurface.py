...
# https://examples.vtk.org/site/Python/Visualization/FroggieSurface/
# https://gitlab.kitware.com/vtk/vtk-examples/-/blob/master/src/Python/Visualization/FroggieSurface.py
