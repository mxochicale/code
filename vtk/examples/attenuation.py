#SCR: https://kitware.github.io/vtk-examples/site/Python/ImageProcessing/Attenuation/
#DAT: https://gitlab.kitware.com/vtk/vtk-examples/-/blob/master/src/Testing/Data/AttenuationArtifact.pgm
# python attenuation.py _attenuationArtifact.pgm
