##SRC: https://kitware.github.io/vtk-examples/site/Python/Medical/MedicalDemo1/
##DATA: https://gitlab.kitware.com/vtk/vtk-examples/-/blob/master/src/Testing/Data/FullHead.mhd
# python medical_demo1.py FullHead.mhd 
